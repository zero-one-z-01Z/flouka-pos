...
class ReelsView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final ReelsProvider vendorStoresProvider = Provider.of<ReelsProvider>(context,);
    final ReelsOperationsProvider storeOperationsProvider = Provider.of<ReelsOperationsProvider>(context,);
    return Scaffold(
                    ...
                    return SizedBox(
                      ...
                      child: Stack(
                        ...
                        children: [
                          InkWell(
                            onTap: () {
                              navP(VideoViewPage(video: vendorStoresProvider.data![index].video,));
                            },
                               ...
                               children: [
                                 Container(
                                   ...
                                   decoration: BoxDecoration(
                                       ...
                                       image: DecorationImage(image: CachedNetworkImageProvider(vendorStoresProvider.data![index].cover),
                                           fit: BoxFit.cover)
                                   ),
                                 ),
                                 Container(
                          ...
                          Row(
                            children: [
                              InkWell(
                                onTap: () => storeOperationsProvider.deleteReelDialog(id: vendorStoresProvider.data![index].id),
                                child: Container(
                                  decoration: BoxDecoration(
                                    color: Colors.white,
